    ...
    Grid {
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                readonly property var cornersList: [MD.Util.corners(40, 40, 40, 40)                                // 0: uniform large radius
                    , MD.Util.corners(60, 0, 0, 60)                                // 1: diagonal (TL + BR)
                    , MD.Util.corners(height / 2, height / 2, height / 2, height / 2)                       // 2: pill / stadium
                ...
                readonly property var touchList: [Qt.point(0.30, 0.45), Qt.point(0.20, 0.25), Qt.point(0.50, 0.50), Qt.point(0.50, 0.30), Qt.point(0.50, 0.70), Qt.point(0.85, 0.20)]
