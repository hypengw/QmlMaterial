...
{
    if (argc < 3) {
        std::cerr << "Usage: qm_grab <input.qml> <output.png> [width=800] [height=600] [delay_ms=200]\n";
        return 1;
    }
    ...
    QRhiTexture *colorTex = rhi->newTexture(QRhiTexture::RGBA8, sz, 1,
    ...
    QRhiRenderBuffer *dsRb = rhi->newRenderBuffer(QRhiRenderBuffer::DepthStencil, sz, 1,
