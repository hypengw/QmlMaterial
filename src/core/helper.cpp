...
void convert_from(MdScheme& out, const md::DynamicScheme& in) {
    ...
    out.primary_fixed              = in.GetPrimaryFixed();
    out.primary_fixed_dim          = in.GetPrimaryFixedDim();
    out.on_primary_fixed           = in.GetOnPrimaryFixed();
    out.on_primary_fixed_variant   = in.GetOnPrimaryFixedVariant();
    ...
    out.secondary_fixed            = in.GetSecondaryFixed();
    out.secondary_fixed_dim        = in.GetSecondaryFixedDim();
    out.on_secondary_fixed         = in.GetOnSecondaryFixed();
    out.on_secondary_fixed_variant = in.GetOnSecondaryFixedVariant();
    ...
    out.tertiary_fixed             = in.GetTertiaryFixed();
    out.tertiary_fixed_dim         = in.GetTertiaryFixedDim();
    out.on_tertiary_fixed          = in.GetOnTertiaryFixed();
    out.on_tertiary_fixed_variant  = in.GetOnTertiaryFixedVariant();
