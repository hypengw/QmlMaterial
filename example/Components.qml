...
MD.Page {
    ...
    title: 'Components'
    padding: 0
    rightInset: twoColumns ? width - m_first_pane.width : 0
    readonly property bool twoColumns: availableWidth >= MD.Token.window_class.large.min_width
    ...
    MD.SplitView {
        id: m_split
        objectName: "componentsSplitView"
        anchors.fill: parent
        orientation: Qt.Horizontal

        MD.VerticalFlickable {
            id: m_first_pane
            objectName: "componentsFirstPane"
            implicitWidth: m_first_column.implicitWidth
            MD.SplitViewBase.minimumWidth: root.twoColumns ? implicitWidth : 0
            MD.SplitViewBase.preferredWidth: m_split.width / 2
            topMargin: 16
            bottomMargin: 16
            clip: true
            ...
            ColumnLayout {
                id: m_first_column
                objectName: "componentsFirstColumn"
                width: parent.width
        ...
        MD.Pane {
            objectName: "componentsSecondPanel"
            visible: root.twoColumns
            MD.SplitViewBase.minimumWidth: implicitWidth
            ...
            contentItem: MD.VerticalFlickable {
                id: m_second_pane
                objectName: "componentsSecondPane"
                implicitWidth: m_second_column.implicitWidth
                topMargin: 16
                bottomMargin: 16
                clip: true
                ...
                ColumnLayout {
                    id: m_second_column
                    objectName: "componentsSecondColumn"
                    parent: root.twoColumns ? m_second_pane.contentItem : m_first_column
                    width: parent.width
                    Layout.fillWidth: true

                    Binding on y {
                        when: root.twoColumns
                        value: 0
                            ...
                            ComponentCard {
                                ...
                                RowLayout {
                                    ...
                                    ColumnLayout {
                                        ...
                                        MD.Slider {
                                            Layout.fillWidth: true
                                            snapMode: MD.SliderBase.SnapAlways
                                            from: 0
                                            stepSize: 20
                                            to: 100
                                            labelBehavior: MD.Enum.SliderLabelGone
    ...
    MD.BottomSheet {
        id: m_standard_sheet
        objectName: "exampleStandardSheet"
    ...
    MD.SnakeView {
        id: m_snake
        objectName: "exampleSnakeView"
        parent: root.MD.Overlay.overlay
        anchors.fill: parent
        MD.InputBlock {
            target: m_snake
        }
