...
public:
    ...
    i32   item_corner { 28 };
    i32   snap_duration { int(Duration {}.medium4) };
...
class Token : public QObject {
    ...
    Q_PROPERTY(qml_material::token::ComboBoxSize combo_box READ combo_box CONSTANT FINAL)
...
public:
    ...
    auto combo_box() const -> const ComboBoxSize&;
